...
set(Qt5Network_VERSION_STRING 5.11.1)
...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/QtNetwork/5.11.1"
        "${_qt5Network_install_prefix}/include/QtNetwork/5.11.1/QtNetwork"
    )
    ...
    foreach(_module_dep ${_Qt5Network_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.1 ${_Qt5Network_FIND_VERSION_EXACT}
