...
set(Qt5Qml_VERSION_STRING 5.15.3)
...
if (NOT TARGET Qt5::Qml)
    ...
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/QtQml/5.15.3"
        "${_qt5Qml_install_prefix}/include/QtQml/5.15.3/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5Qml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5Qml_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Qml
                 ...
                 cxx14_make_unique;qml-animation;qml-itemmodel;qml-locale;qml-preview;qml-profiler;qml-python;qml-sequence-object;qml-xml-http-request)
    set_property(TARGET Qt5::Qml
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 qml-devtools;qml-jit;qml-worker-script)
