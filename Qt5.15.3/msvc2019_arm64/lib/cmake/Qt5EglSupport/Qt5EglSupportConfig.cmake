...
set(Qt5EglSupport_VERSION_STRING 5.15.3)
...
if (NOT TARGET Qt5::EglSupport)
    ...
    set(Qt5EglSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EglSupport_install_prefix}/include/QtEglSupport/5.15.3"
        "${_qt5EglSupport_install_prefix}/include/QtEglSupport/5.15.3/QtEglSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EglSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5EglSupport_FIND_VERSION_EXACT}
