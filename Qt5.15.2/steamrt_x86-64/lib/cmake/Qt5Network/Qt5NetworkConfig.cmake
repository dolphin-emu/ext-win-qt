...
if (NOT TARGET Qt5::Network)
    ...
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_ENABLED_FEATURES dnslookup;ftp;gssapi;http;localserver;networkdiskcache;networkinterface;networkproxy;socks5;udpsocket)
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_DISABLED_FEATURES bearermanagement;securetransport;schannel;dtls;opensslv11;ocsp;sctp;ssl;sspi)

    # Qt 6 forward compatible properties.
    set_property(TARGET Qt5::Network
                 PROPERTY QT_ENABLED_PUBLIC_FEATURES
                 dnslookup;ftp;gssapi;http;localserver;networkdiskcache;networkinterface;networkproxy;socks5;udpsocket)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PUBLIC_FEATURES
                 bearermanagement;securetransport;schannel;dtls;opensslv11;ocsp;sctp;ssl;sspi)
    set_property(TARGET Qt5::Network
